                ...
                success: function(data) {
                    ...
                    var prodList = {
                        ...
                        appendInfo_jijin: function() {
                            ...
                            ajax({
                                    type: "GET",
                                    url: "http://jijin.pingan.com/jijin/interface.do?m=grf&fundCode=" + prodList.lc_riskID1,
                                    dataType: "jsonp",
                                    callback: "callback",
                                    cache: false,
                                    success: function(riskdata1) {
                                        var riskLevel1 = riskdata1.risk;
                                        var riskobj = {
                                            "1": "低风险",
                                            "2": "中低风险",
                                            "3": "中风险",
                                        ...
                                        self.result.riskStr1 = riskobj[riskLevel1];
                            ...
                            ajax({
                                type: "GET",
                                url: "http://jijin.pingan.com/jijin/interface.do?m=grf&fundCode=" + prodList.lc_riskID3,
                                dataType: "jsonp",
                                callback: "callback",
                                cache: false,
                                success: function(riskdata3) {
                                    var riskLevel3 = riskdata3.risk;
                                    var riskobj = {
                                        "1": "低风险",
                                        "2": "中低风险",
                                        "3": "中风险",
                                    ...
                                    self.result.riskStr3 = riskobj[riskLevel3];
                                    //console.log(buildHtml());
                                    getElem("#hotFundList").innerHTML = buildHtml();
                                },
                                error: function() {
                                    alert("服务器繁忙：请刷新页面或稍后再试，给您带来不便请谅解 :\)");
                                }
                            ...
                            function buildHtml() {
                                var riskStr1 = self.result.riskStr1,
                                    riskStr3 = self.result.riskStr3,
                                    contents;
                                    console.log(riskStr1);
                                if (riskStr1 && riskStr3) {

                                    contents = '<a href="http://m.pingan.com/chaoshi/jijin/' + prodList.lc_riskID1 + '.shtml' + (_cid ? '?cid=' + _cid : '') + '" otitle="APP旗舰店首页-投资理财-基金-产品1">' +
                                        ...
                                        '<li>' +
                                        '<p>' +
                                        '<em>' + prodList.lc_unitNV1 + '</em>' +
                                        '</p>' +
                                        '<p>单位净值（元）</p>' +
                                        '</li>' +
                                        '<li>' +
                                        '<p>' +
                                        '<em>' + prodList.lc_monthRate1 + '</em>' +
                                        '</p>' +
                                        '<p class="net_value">近1月涨幅（%）</p>' +
                                        '</li>' +
                                        '</ul>' +
                                        '</a>' +
                                        '<a href="http://m.pingan.com/chaoshi/jijin/' + prodList.lc_riskID3 + '.shtml' + (_cid ? '?cid=' + _cid : '') + '" otitle="APP旗舰店首页-投资理财-基金-产品2">' +
                                        '<div class="kind_title">' +
                                        '<h3 class="nopre">' +
                                        ...
                                        '<li>' +
                                        '<p>' +
                                        '<em>' + prodList.lc_unitNV3 + '</em>' +
                                        '</p>' +
                                        '<p>单位净值（元）</p>' +
                                        '</li>' +
                                        '<li>' +
                                        '<p>' +
                                        '<em>' + prodList.lc_monthRate3 + '</em>' +
                                        '</p>' +
                        ...
                        appendInfo_lufax: function() {
                            ...
                            for (var i = 0; i < lu_conLen; i++) {
                                ...
                                contents +=
                                    ...
                                    '<div class="kind_title">' +
                                    '<h3 class="nopre">' + prodList.lc_ljs_prodName(i) +
                        ...
                        appendInfo_dae: function() {
                            ...
                            for (var i = 0; i < dae_conLen; i++) {
                                ...
                                contents +=
                                    ...
                                    '<div class="kind_title">' +
                                    '<h3>' + prodList.lc_dae_productName(i) + '</h3>' +
                        ...
                        appendInfo_house: function() {
                            ...
                            for (var i = 0; i < house_conLen; i++) {
                                ...
                                Num_unit = unitNum[unit];
                                contents +=
                                    '<a href="http://m.pingan.com/chaoshi/licai/' + prodList.lc_house_id(i) + '.shtml' + (_cid ? "?cid=" + _cid : "") + '" otitle="APP旗舰店首页-投资理财-好房众筹-产品' + k + '">' +
                                    '<div class="kind_title">' +
                                    '<h3>' + prodList.lc_house_productName(i) + '</h3>' +
                                    ...
                                    '<li>' +
                                    '<p>距开放认筹' +
                                    '<em class="lucount">' + prodList.lc_house_timeLimit(i) + "天" + '</em>' +
                                    '</p>' +
                                    '</li>' +
                                    '</ul>' +
                                    '</a>'
